...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order.tex_total'
        db.add_column(u'orders_order', 'tex_total',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Order.tex_total'
        db.delete_column(u'orders_order', 'tex_total')
    ...
    models = {
        ...
        u'orders.order': {
            ...
            'tex_total': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '1000', 'decimal_places': '2'}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
